class Settings < ActiveRecord::Base
	belongs_to :event
		attr_accessible :event_id, :notify_on_guest_accept, :notify_on_guest_decline, :notify_on_guest_response, :days_rsvp_reminders, :days_event_reminders, :disable_suggestions
